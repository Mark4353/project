...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    document.addEventListener("submit", async (e)=>{
        if (e.target.classList.contains("createCommentForm")) {
            ...
            if (input && input.value.trim()) await createComment(id, input.value.trim());
        }
    });
});
async function getPosts() {
    try {
        ...
        if (Array.isArray(posts)) renderPosts(posts);
        else console.error("\u041E\u0447\u0456\u043A\u0443\u0432\u0430\u0432 \u043C\u0430\u0441\u0438\u0432, \u0430\u043B\u0435 \u043E\u0442\u0440\u0438\u043C\u0430\u0432:", posts);
    } catch (e) {
...
function renderPosts(posts) {
    ...
    posts.forEach((post)=>{
      ...
      <div class="post_buttons">
        <button class="editPostButton post_edit_button" data-id="${posts.id}">\u{420}\u{435}\u{434}\u{430}\u{433}\u{443}\u{432}\u{430}\u{442}\u{438}</button>
        <button class="deletePostButton post_del_button" data-id="${posts.id}">\u{412}\u{438}\u{434}\u{430}\u{43B}\u{438}\u{442}\u{438}</button>
      </div>
      <div class="comments_box">
        ...
        <form class="createCommentForm" data-id="${posts.id}">
          ${posts.comments.length >= 4 ? "" : `<input type="text" class="commentInput comment_input" placeholder="\u{41D}\u{43E}\u{432}\u{438}\u{439} \u{43A}\u{43E}\u{43C}\u{435}\u{43D}\u{442}\u{430}\u{440}" required>`}
          ${posts.comments.length >= 4 ? "" : `<button type="submit" class="comment_add_button">\u{414}\u{43E}\u{434}\u{430}\u{442}\u{438} \u{43A}\u{43E}\u{43C}\u{435}\u{43D}\u{442}\u{430}\u{440}</button>`}
        </form>
      </div>
    `;
...
},{}]},["5j6Kf","a0t4e"], "a0t4e", "parcelRequirebbb8", {})
